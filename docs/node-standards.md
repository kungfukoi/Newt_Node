...
- Director references remain typed as character, location, prop/image, and style inputs. Expanding a director package for a downstream node must preserve direct downstream inputs and deduplicate inherited references.
