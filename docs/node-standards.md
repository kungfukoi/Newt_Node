...
- MiniMax H3 supports 5-15 seconds, `480P`/`768P`/`2K`/`4K`, seed, prompt expansion, and safety checking through Fal. The current Local SGLang integration supports `768P` only and rejects other selections instead of silently changing resolution. Text-to-video accepts `21:9`, `16:9`, `4:3`, `1:1`, `3:4`, or `9:16`; image-to-video follows the source image; reference-to-video adds `adaptive`.
