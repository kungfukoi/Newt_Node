...
- OpenAI Image 2.5 uses the Fal key and preserves Fal Flare quality-specific generation/edit pricing metadata. The Image Model node also retains `OpenAI Image 2` as an explicit legacy Fal/Krea option with its original quality tiers and pricing.
