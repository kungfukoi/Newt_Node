    ...
    return (
      <div className="node-body character-node-body">
        ...
        {activeTab === "build" ? (
          ...
          <section className={`character-sheet-view ${characterSheetItem?.url ? "has-image" : ""} drop-enabled`} onDragOver={allowFileDrop} onDrop={(event) => handleCharacterDrop(event, "sheet")}>
